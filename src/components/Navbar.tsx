      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div className="navbar-nav">
            <a className="nav-link" href="https://en.wikipedia.org/wiki/Chmod" target="_blank" rel="noopener">Wikipedia</a>
            <a className="nav-link" href="https://linux.die.net/man/1/chmod" target="_blank" rel="noopener">Man page</a>
          </div>
        </div>
      </div>
    </nav>
